...
const Hero = () => {
  ...
  return (
    <View
      className="flex flex-1 justify-center bg-[#FFF7D3]"
      style={{
      ...
      <View className="relative items-center">
        <Text
          className="z-10 w-full text-center text-[#403284]"
        ...
        <View
          ...
          <Svg width="100%" height="100%" viewBox="0 0 370 362" fill="none">
            <Path
              d="M110.92 123.147L89.4404 18.3033L173.229 89.1419L237.791 0.253921L242.712 103.72L353.133 81.7154L274.504 163.949L369.845 226.266L254.321 234.021L276.265 340.16L192.11 272.376L127.548 361.264L122.53 253.448L14.3313 277.58L90.2742 191.924L0.304924 136.452L110.92 123.147Z"
              fill="#FED25C"
            />
          </Svg>
        </View>
        ...
        <View
          ...
          style={{
            ...
            top: verticalScale(354),
            left: scale(40),
          }}>
          <Svg width="100%" height="100%" viewBox="0 0 139 136" fill="none">
            <Path
              d="M41.5514 46.6499L33.5379 7.53584L64.7968 33.9636L88.8829 0.802161L90.7187 39.4023L131.913 31.193L102.579 61.8718L138.148 85.1203L95.05 88.0136L103.237 127.611L71.8409 102.323L47.7548 135.484L45.8827 95.2613L5.51698 104.264L33.849 72.3085L0.28416 51.6137L41.5514 46.6499Z"
              fill="#00C4FF"
            />
          </Svg>
        </View>
      ...
      {/* RoundCast Title */}
      <Text
        className="items-center text-center text-[#1E0F59]"
        style={{
      ...
      <View className="items-center">
        <TouchableOpacity
          ...
          <Text
            className="text-center text-[#1E0F59]"
            style={{ fontFamily: 'Anton-Regular', fontSize: scale(28) }}>
